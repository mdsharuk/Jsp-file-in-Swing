...
<head>
  ...
  <title>Study with shahrukh khan</title>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
          <h1 class="logo"><a href="index.html">Study with shahrukh </a></h1>
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto " href="student.jsp">Student</a></li>
              <li><a class="nav-link scrollto" href="teacher.jsp">Teacher</a></li>
